...
import com.bookstore.admin.ui.book_category.add.AddBookCategoryViewModel
import com.bookstore.admin.ui.book_category.edit.EditBookCategoryViewModel
...
val appModule = module {
    ...
    viewModel { AddBookCategoryViewModel(get(), get()) }
    viewModel { EditBookCategoryViewModel(get(), get()) }
}